...
@Component({
    ...
    styles: '',
    providers: [
        provideTranslocoScope({ scope: 'projects/BigExcelCreator/data-validation', alias: 'projects.BigExcelCreator.DataValidation' }, { scope: 'projects/BigExcelCreator', alias: 'projects.BigExcelCreator' })
    ],
