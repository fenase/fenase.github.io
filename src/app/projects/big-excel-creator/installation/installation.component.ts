...
@Component({
    ...
    styles: '',
    providers: [
        provideTranslocoScope({ scope: 'projects/BigExcelCreator/installation', alias: 'projects.BigExcelCreator.installation' }, { scope: 'projects/BigExcelCreator', alias: 'projects.BigExcelCreator' })
    ],
